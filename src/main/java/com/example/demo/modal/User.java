...
//	private Set<UserDto> following = new HashSet<>();
	...
	@ManyToMany	// same post can be save by many users
...
//			List<Story> stories, List<Post> savedPost) {
		public User(Integer id, String name, String username, String email, String mobile, String website, String bio,
				String gender, String image, String passwor, List<Story> stories, List<Post> savedPost) {
		super();
		this.id = id;
		this.name = name;
...
//	}
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", username=" + username + ", email=" + email + ", mobile="
				+ mobile + ", website=" + website + ", bio=" + bio + ", gender=" + gender + ", image=" + userImage
				+ ", password=" + password +"]";
	}
}
